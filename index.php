...
<head>
    ...
    <style>
      body {
        ...
        background-color:rgb(126, 0, 0); /* Lighter, more modern background */
        margin: 20px;
        padding: 20px;
        display: flex;
    ...
    h1 {
        ...
        border-bottom: 3px solid #888888; /* Changed to a modern blue accent, consistent with login */
...
<body>
<h1>DATA BUKU<br>SMK Telkom Lampung<br></h1>
