...
.register-link a:hover {
  text-decoration: underline;
    ...
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    background-color:rgb(139, 0, 0); /* Lighter, more modern background */
    margin: 0;
    padding: 0;
    display: flex;
    justify-content: center;
...
.box {
    background-color: rgba(250, 248, 248, 0.95); /* Slightly less transparent */
...
input[type="text"]:focus,
input[type="password"]:focus {
    border-color:rgb(255, 0, 0); /* Focus color matches accent */
    outline: none;
    box-shadow: 0 0 0 3px rgba(255, 0, 0, 0.25); /* Glow effect on focus */
}

input[type="submit"] {
    width: 100%;
    padding: 15px 20px; /* Larger button padding */
    background-color:rgb(139, 2, 2); /* Primary blue button */
    color: white;
    border: none;
...
input[type="submit"]:hover {
    background-color:rgb(179, 0, 0); /* Darker blue on hover */
    transform: translateY(-3px); /* Subtle lift on hover */
    box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2); /* Shadow on hover */
}

input[type="submit"]:active {
    background-color:rgb(88, 3, 0); /* Even darker blue on active */
