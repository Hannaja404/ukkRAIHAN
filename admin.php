...
<head>
    ...
    background-color:rgb(138, 0, 0); /* Lighter, more modern background */
    margin: 20px;
    padding: 20px;
    display: flex;
...
h2 {
    ...
    border-bottom: 3px solid #920000; /* Consistent modern blue accent */
...
input[type="file"]:focus { /* Added file input focus styling */
    border-color:rgb(133, 0, 0); /* Focus color matches accent */
    outline: none;
...
input[type="submit"] {
    ...
    background-color:rgb(143, 0, 0); /* Changed to primary blue */
    color: white;
    border: none;
...
input[type="submit"]:active {
    background-color:rgb(133, 0, 0); /* Even darker blue on active */
