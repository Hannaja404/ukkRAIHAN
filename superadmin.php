...
input[type="submit"] {
    ...
    background-color:rgb(146, 0, 0); /* Consistent primary blue button */
    color: white;
    border: none;
...
input[type="submit"]:hover {
    background-color:rgb(77, 0, 0); /* Darker blue on hover */
    transform: translateY(-3px); /* Subtle lift on hover */
    box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2); /* Shadow on hover */
}

input[type="submit"]:active {
    background-color:rgb(85, 0, 0); /* Even darker blue on active */
